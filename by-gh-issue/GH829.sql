...
CL: GRTOBJAUT OBJ(ACS_5OBJ/AR_APRORDR) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);
CL: GRTOBJAUT OBJ(ACS_5OBJ/AC_APRORDR) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);
CL: GRTOBJAUT OBJ(ACS_5OBJ/TS_APRORDR) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);
...
-- TS_APRORDR
CL: CPYSRCF FROMFILE(ACS_5DEV/QCLLESRC) TOFILE(WEB_5TDV/QCLLESRC) FROMMBR(TS_APRORDR) TOMBR(TS_APRORDR);
CL: CRTBNDCL PGM(WEB_5TST/TS_APRORDR) SRCFILE(WEB_5TDV/QCLLESRC) OPTION(*EVENTF) DBGVIEW(*SOURCE);

CL: GRTOBJAUT OBJ(WEB_5TST/AR_APRORDR) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);
CL: GRTOBJAUT OBJ(WEB_5TST/AC_APRORDR) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);
CL: GRTOBJAUT OBJ(WEB_5TST/TS_APRORDR) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);
...
-- TS_APRORDR
CL: CPYSRCF FROMFILE(WEB_5TDV/QCLLESRC) TOFILE(WEB_5DEV/QCLLESRC) FROMMBR(TS_APRORDR) TOMBR(TS_APRORDR);
CL: CRTBNDCL PGM(WEB_5OBJ/TS_APRORDR) SRCFILE(WEB_5DEV/QCLLESRC) OPTION(*EVENTF);


CL: GRTOBJAUT OBJ(WEB_5OBJ/AR_APRORDR) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);
CL: GRTOBJAUT OBJ(WEB_5OBJ/AC_APRORDR) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);
CL: GRTOBJAUT OBJ(WEB_5OBJ/TS_APRORDR) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);
