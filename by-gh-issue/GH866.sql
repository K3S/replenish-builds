...
CL: CRTCMD CMD(WEB_5TST/AC_PSIREPT) PGM(WEB_5TST/AC_PSIREPT) SRCFILE(WEB_5TDV/QCMDSRC) ALLOW(*ALL) CURLIB(*NOCHG) PRDLIB(*NOCHG);
...
CL: CRTCMD CMD(WEB_5OBJ/AC_PSIREPT) PGM(WEB_5OBJ/AC_PSIREPT) SRCFILE(WEB_5DEV/QCMDSRC) ALLOW(*ALL) CURLIB(*NOCHG) PRDLIB(*NOCHG);

-- Set to current date
CL: CHGDTAARA DTAARA(WEB_5OBJ/AR_RELEASE *ALL) VALUE('052422');
