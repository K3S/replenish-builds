...
CL: CRTSQLRPGI OBJ(WEB_5OBJ/AR_PRODLTM) SRCFILE(WEB_5DEV/QRPGLESRC) COMMIT(*NONE) OPTION(*EVENTF *XREF) TGTRLS(V7R2M0) TEXT('Web-Service Prog. 2 Insert/Delete/Update K_PRODLTM');

-- AR_POSTS
CL: CPYSRCF FROMFILE(WEB_5TDV/QRPGLESRC) TOFILE(WEB_5DEV/QRPGLESRC) FROMMBR(AR_POSTS) TOMBR(AR_POSTS);
CL: CRTSQLRPGI OBJ(WEB_5OBJ/AR_POSTS) SRCFILE(WEB_5DEV/QRPGLESRC) COMMIT(*NONE) OPTION(*EVENTF *XREF) TGTRLS(V7R2M0) TEXT('Web-Service Prog. PO Status Checks');
...
CL: GRTOBJAUT OBJ(WEB_5OBJ/AR_PRODLTM WEB_5OBJ/AR_POSTS WEB_5OBJ/AR_INTORDL WEB_5OBJ/AR_PUSORDR WEB_5OBJ/AC_LTMAPOR WEB_5OBJ/AC_LTMAPO2 WEB_5OBJ/AR_LTMAPOR WEB_5OBJ/AC_ADJAPOR) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);
...
CL: SBMJOB CMD(CALL PGM(ACS_5OBJ/K3S_NITECL) PARM('C' 'ACS_5DTA' 'ACS_5DLY' 'ACS_5OBJ' 'ACS_5MOD')) JOB(WEB_5NITE) JOBQ(QGPL/WEB_BATCH) INLLIBL(*CURRENT) LOG(*JOBD 10) JOBMSGQFL(*WRAP) HOLD(*YES);
CL: STRSRVJOB JOB(455658/CHUK/WEB_5NITE);
CL: STRDBG PGM(ACS_5OBJ/AR_LTMAPOR) UPDPROD(*YES);
