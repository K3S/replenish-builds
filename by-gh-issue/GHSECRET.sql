...
-- AC_JBQREPT
CL: CRTBNDCL PGM(ACS_5OBJ/AC_JBQREPT) SRCFILE(ACS_5DEV/QCLLESRC) OPTION(*EVENTF) DBGVIEW(*SOURCE);
CL: GRTOBJAUT OBJ(ACS_5OBJ/AC_JBQREPT) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);

-- AC_BYSREPT
CL: CRTBNDCL PGM(ACS_5OBJ/AC_BYSREPT) SRCFILE(ACS_5DEV/QCLLESRC) OPTION(*EVENTF) DBGVIEW(*SOURCE);
CL: GRTOBJAUT OBJ(ACS_5OBJ/AC_BYSREPT) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);
...
-- APIs
CL: CALL PGM(DEVTOOLS/APIPRART) PARM('AR_JBQREPT' 'ACS_5DEV' 'QRPGLESRC' 'QRPGLESRC' 'WEB_5TDV' 'WEB_5TST' 'QSRVSRC' 'K3SDIR');

-- CL Wrappers
CL: CALL PGM(DEVTOOLS/APIPRACT) PARM('AC_JBQREPT' 'ACS_5DEV' 'QCLLESRC' 'QCLLESRC' 'WEB_5TDV' 'WEB_5TST' 'QSRVSRC' 'K3SDIR');
CL: CALL PGM(DEVTOOLS/APIPRACT) PARM('AC_BYSREPT' 'ACS_5DEV' 'QCLLESRC' 'QCLLESRC' 'WEB_5TDV' 'WEB_5TST' 'QSRVSRC' 'K3SDIR');
