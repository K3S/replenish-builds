...
CL: CPYFRMSTMF FROMSTMF('/home/chuk/API-RPG/adjtlog_h.sqlrpgle') TOMBR('/qsys.lib/acs_5dev.lib/qrpglesrc.file/adjtlog_h.mbr');

-------------------------------
--          Tables
-------------------------------
CL: DLTF FILE(ACS_5MOD/K_LCNWORK);
CL: CRTPF FILE(ACS_5MOD/K_LCNWORK) SRCFILE(ACS_5SRC/QDDSSRC) SRCMBR(K_LCNWORK) IGCDTA(*N);

CL: DLTF FILE(ACS_5MOD/K_BUYWORK);
CL: CRTPF FILE(ACS_5MOD/K_BUYWORK) SRCFILE(ACS_5SRC/QDDSSRC) SRCMBR(K_BUYWORK) IGCDTA(*N);
...
-- AR_LCNWORK
CL: CRTSQLRPGI OBJ(ACS_5OBJ/AR_LCNWORK) SRCFILE(ACS_5DEV/QRPGLESRC) COMMIT(*NONE) OPTION(*EVENTF *XREF) DBGVIEW(*SOURCE) TGTRLS(V7R3M0);
CL: GRTOBJAUT OBJ(ACS_5OBJ/AR_LCNWORK) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);

-- AC_LCNWORK
CL: CRTBNDCL PGM(ACS_5OBJ/AC_LCNWORK) SRCFILE(ACS_5DEV/QCLLESRC) OPTION(*EVENTF) DBGVIEW(*SOURCE);
CL: GRTOBJAUT OBJ(ACS_5OBJ/AC_LCNWORK) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);

-- AR_BUYWORK
CL: CRTSQLRPGI OBJ(ACS_5OBJ/AR_BUYWORK) SRCFILE(ACS_5DEV/QRPGLESRC) COMMIT(*NONE) OPTION(*EVENTF *XREF) DBGVIEW(*SOURCE) TGTRLS(V7R3M0);
CL: GRTOBJAUT OBJ(ACS_5OBJ/AR_BUYWORK) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);

-- AC_BUYWORK
CL: CRTBNDCL PGM(ACS_5OBJ/AC_BUYWORK) SRCFILE(ACS_5DEV/QCLLESRC) OPTION(*EVENTF) DBGVIEW(*SOURCE);
CL: GRTOBJAUT OBJ(ACS_5OBJ/AC_BUYWORK) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);
...
-- Tables
CL: CPYSRCF FROMFILE(ACS_5SRC/QDDSSRC) TOFILE(WEB_5MOD/QDDSSRC) FROMMBR(K_LCNWORK) TOMBR(K_LCNWORK);
CL: CRTPF FILE(WEB_5MOD/K_LCNWORK) SRCFILE(WEB_5MOD/QDDSSRC) SRCMBR(K_LCNWORK) IGCDTA(*N);

CL: CPYSRCF FROMFILE(ACS_5SRC/QDDSSRC) TOFILE(WEB_5MOD/QDDSSRC) FROMMBR(K_BUYWORK) TOMBR(K_BUYWORK);
CL: CRTPF FILE(WEB_5MOD/K_BUYWORK) SRCFILE(WEB_5MOD/QDDSSRC) SRCMBR(K_BUYWORK) IGCDTA(*N);

-- APIs
CL: CALL PGM(DEVTOOLS/APIPRART) PARM('AR_LCNWORK' 'ACS_5DEV' 'QRPGLESRC' 'QRPGLESRC' 'WEB_5TDV' 'WEB_5TST' 'QSRVSRC' 'K3SDIR');
CL: CALL PGM(DEVTOOLS/APIPRART) PARM('AR_BUYWORK' 'ACS_5DEV' 'QRPGLESRC' 'QRPGLESRC' 'WEB_5TDV' 'WEB_5TST' 'QSRVSRC' 'K3SDIR');

-- CL Wrappers
CL: CALL PGM(DEVTOOLS/APIPRACT) PARM('AC_LCNWORK' 'ACS_5DEV' 'QCLLESRC' 'QCLLESRC' 'WEB_5TDV' 'WEB_5TST' 'QSRVSRC' 'K3SDIR');
CL: CALL PGM(DEVTOOLS/APIPRACT) PARM('AC_BUYWORK' 'ACS_5DEV' 'QCLLESRC' 'QCLLESRC' 'WEB_5TDV' 'WEB_5TST' 'QSRVSRC' 'K3SDIR');

-- Tests
CL: CALL PGM(DEVTOOLS/APIPRACT) PARM('TS_LCNWORK' 'ACS_5DEV' 'QCLLESRC' 'QCLLESRC' 'WEB_5TDV' 'WEB_5TST' 'QSRVSRC' 'K3SDIR');
CL: CALL PGM(DEVTOOLS/APIPRACT) PARM('TS_BUYWORK' 'ACS_5DEV' 'QCLLESRC' 'QCLLESRC' 'WEB_5TDV' 'WEB_5TST' 'QSRVSRC' 'K3SDIR');
