...
-------------------------------
-- AR_DELDEAL
CL: CRTSQLRPGI OBJ(ACS_5OBJ/AR_DELDEAL) SRCFILE(ACS_5DEV/QRPGLESRC) COMMIT(*NONE) OPTION(*EVENTF *XREF) DBGVIEW(*SOURCE) TGTRLS(V7R3M0);
CL: GRTOBJAUT OBJ(ACS_5OBJ/AR_DELDEAL) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);
...
CL: CPYSRCF FROMFILE(ACS_5DEV/QRPGLESRC) TOFILE(WEB_5TDV/QRPGLESRC) FROMMBR(PRODHLD_H) TOMBR(PRODHLD_H);

-- Service programs
CL: CALL PGM(ACS_5OBJ/APIPRSRVT) PARM('AR_PRODHLD' 'ACS_5DEV' 'QRPGLESRC' 'QRPGLESRC' 'WEB_5TDV' 'WEB_5TST' 'QSRVSRC' 'K3SDIR');

-- APIs
CL: CALL PGM(DEVTOOLS/APIPRART) PARM('AR_DELDEAL' 'ACS_5DEV' 'QRPGLESRC' 'QRPGLESRC' 'WEB_5TDV' 'WEB_5TST' 'QSRVSRC' 'K3SDIR');

-- CL
CL: CALL PGM(DEVTOOLS/APIPRACT) PARM('TS_DELDEAL' 'ACS_5DEV' 'QCLLESRC' 'QCLLESRC' 'WEB_5TDV' 'WEB_5TST' 'QSRVSRC' 'K3SDIR');
...
-- Service Programs
CL: CALL PGM(DEVTOOLS/APIPRSRVT) PARM('AR_PRODHLD' 'WEB_5TDV' 'QRPGLESRC' 'QRPGLESRC' 'WEB_5DEV' 'WEB_5OBJ' 'QSRVSRC' 'K3SDIR');
...
CL: SAVOBJ OBJ(AR_PRODHLD AR_DELDEAL) LIB(WEB_5OBJ) DEV(*SAVF) SAVF(QGPL/k3shotfix);
CL: SAVOBJ OBJ(AR_PRODHLD AR_DELDEA) LIB(ACS_5OBJ) DEV(*SAVF) SAVF(QGPL/k3shotfix);
