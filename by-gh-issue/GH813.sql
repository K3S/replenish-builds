...
-- AC_APRORDR
-- CL: CRTBNDCL PGM(ACS_5DEV/AC_APRORDR) SRCFILE(ACS_5DEV/QCLLESRC) OPTION(*EVENTF) DBGVIEW(*SOURCE);
...
CL: SAVOBJ OBJ(AR_APRORDR) LIB(ACS_5DEV) DEV(*SAVF) SAVF(QGPL/r6objects);
