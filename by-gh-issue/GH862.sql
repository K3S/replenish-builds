...
CL: CPYSRCF FROMFILE(WEB_5DEV/QRPGLESRC) TOFILE(ACS_5DEV/QRPGLESRC) FROMMBR(AR_BLDAPOR) TOMBR(AR_BLDAPOR);
CL: CPYSRCF FROMFILE(WEB_5DEV/QRPGLESRC) TOFILE(ACS_5DEV/QRPGLESRC) FROMMBR(calapor_h) TOMBR(calapor_h);
CL: CPYSRCF FROMFILE(WEB_5DEV/QSRVSRC) TOFILE(ACS_5DEV/QSRVSRC) FROMMBR(PRODHLD_B) TOMBR(PRODHLD_B);

-------------------------------
--    Service Programs
-------------------------------
--CL: CALL PGM(DEVTOOLS/APISRVPGM) PARM('AR_PRODHLD' 'ACS_5DEV' 'QRPGLESRC' 'ACS_5OBJ' 'QSRVSRC' 'K3SDIR');

-------------------------------
--          APIs
-------------------------------
-- AR_BLDAPOR
CL: CRTSQLRPGI OBJ(ACS_5OBJ/AR_BLDAPOR) SRCFILE(ACS_5DEV/QRPGLESRC) COMMIT(*NONE) OPTION(*EVENTF *XREF) DBGVIEW(*SOURCE) TGTRLS(V7R3M0);
CL: GRTOBJAUT OBJ(ACS_5OBJ/AR_BLDAPOR) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);

-- AR_ADJAPOR
CL: CRTSQLRPGI OBJ(ACS_5OBJ/AR_ADJAPOR) SRCFILE(ACS_5DEV/QRPGLESRC) COMMIT(*NONE) OPTION(*EVENTF *XREF) DBGVIEW(*SOURCE) TGTRLS(V7R3M0);
CL: GRTOBJAUT OBJ(ACS_5OBJ/AR_ADJAPOR) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);
...
-- APIs
CL: CALL PGM(DEVTOOLS/APIPRART) PARM('AR_BLDAPOR' 'ACS_5DEV' 'QRPGLESRC' 'QRPGLESRC' 'WEB_5TDV' 'WEB_5TST' 'QSRVSRC' 'K3SDIR');
CL: CALL PGM(DEVTOOLS/APIPRART) PARM('AR_ADJAPOR' 'ACS_5DEV' 'QRPGLESRC' 'QRPGLESRC' 'WEB_5TDV' 'WEB_5TST' 'QSRVSRC' 'K3SDIR');
...
-- Service Programs
CL: CALL PGM(DEVTOOLS/APIPRSRVT) PARM('AR_POSTS' 'WEB_5TDV' 'QRPGLESRC' 'QRPGLESRC' 'WEB_5DEV' 'WEB_5OBJ' 'QSRVSRC' 'K3SDIR');

-- APIs
CL: CALL PGM(DEVTOOLS/APIPRARD) PARM('AR_BLDAPOR' 'WEB_5TDV' 'QRPGLESRC' 'QRPGLESRC' 'WEB_5DEV' 'WEB_5OBJ' 'QSRVSRC' 'K3SDIR');
CL: CALL PGM(DEVTOOLS/APIPRARD) PARM('AR_ADJAPOR' 'WEB_5TDV' 'QRPGLESRC' 'QRPGLESRC' 'WEB_5DEV' 'WEB_5OBJ' 'QSRVSRC' 'K3SDIR');
CL: CALL PGM(DEVTOOLS/APIPRARD) PARM('AR_PUSORDR' 'WEB_5TDV' 'QRPGLESRC' 'QRPGLESRC' 'WEB_5DEV' 'WEB_5OBJ' 'QSRVSRC' 'K3SDIR');

-- Set to current date
CL: CHGDTAARA DTAARA(WEB_5OBJ/AR_RELEASE *ALL) VALUE('051922');
...
CL: SAVOBJ OBJ(AR_BLDAPOR AR_ADJAPOR AR_PUSORDR AR_POSTS) LIB(WEB_5TST) DEV(*SAVF) SAVF(QGPL/k3shotfix);
