...
-- AR_RNKREPT
CL: CRTSQLRPGI OBJ(ACS_5OBJ/AR_RNKREPT) SRCFILE(ACS_5DEV/QRPGLESRC) COMMIT(*NONE) OPTION(*EVENTF *XREF) DBGVIEW(*SOURCE) TGTRLS(V7R3M0);
CL: GRTOBJAUT OBJ(ACS_5OBJ/AR_RNKREPT) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);

-- AC_RNKREPT
CL: CRTBNDCL PGM(ACS_5OBJ/AC_RNKREPT) SRCFILE(ACS_5DEV/QCLLESRC) OPTION(*EVENTF) DBGVIEW(*SOURCE);
CL: GRTOBJAUT OBJ(ACS_5OBJ/AC_RNKREPT) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);

-- TS_RNKREPT
CL: CRTBNDCL PGM(ACS_5OBJ/TS_RNKREPT) SRCFILE(ACS_5DEV/QCLLESRC) OPTION(*EVENTF) DBGVIEW(*SOURCE);
CL: GRTOBJAUT OBJ(ACS_5OBJ/TS_RNKREPT) OBJTYPE(*PGM) USER(*PUBLIC) AUT(*ALL);
...
-- APIs
CL: CALL PGM(DEVTOOLS/APIPRART) PARM('AR_RNKREPT' 'ACS_5DEV' 'QRPGLESRC' 'QRPGLESRC' 'WEB_5TDV' 'WEB_5TST' 'QSRVSRC' 'K3SDIR');

-- CL Wrappers
CL: CALL PGM(DEVTOOLS/APIPRACT) PARM('AC_RNKREPT' 'ACS_5DEV' 'QCLLESRC' 'QCLLESRC' 'WEB_5TDV' 'WEB_5TST' 'QSRVSRC' 'K3SDIR');

-- Tests
CL: CALL PGM(DEVTOOLS/APIPRACT) PARM('TS_RNKREPT' 'ACS_5DEV' 'QCLLESRC' 'QCLLESRC' 'WEB_5TDV' 'WEB_5TST' 'QSRVSRC' 'K3SDIR');
...
-- Copy binder source
CL: CPYSRCF FROMFILE(WEB_5WEB/QRPGLESRC) TOFILE(WEB_5WEB/QRPGLESRC) FROMMBR(K3S_APIPRO) TOMBR(K3S_APIPRO);

-- APIs
CL: CALL PGM(DEVTOOLS/APIPRARD) PARM('AR_RNKREPT' 'WEB_5TDV' 'QRPGLESRC' 'QRPGLESRC' 'WEB_5DEV' 'WEB_5OBJ' 'QSRVSRC' 'K3SDIR');

-- CL Wrappers
CL: CALL PGM(DEVTOOLS/APIPRACT) PARM('AC_RNKREPT' 'WEB_5TDV' 'QCLLESRC' 'QCLLESRC' 'WEB_5DEV' 'WEB_5OBJ' 'QSRVSRC' 'K3SDIR');
...
CL: SAVOBJ OBJ(AR_PSIREPT AC_PRIREPT AC_PSIREPT) LIB(ACS_5OBJ) DEV(*SAVF) SAVF(QGPL/APIMISSCHK);
